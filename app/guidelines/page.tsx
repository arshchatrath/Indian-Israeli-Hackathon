...
export default function Guidelines() {
  ...
  const referenceLinks = [
    { name: "Presentation Skills Guide", url: "https://www.youtube.com/watch?v=9EfabrSBFRk" },
  ...
  const slideOutline = [
    { title: "Title Slide", description: "Team name, project title, members" },
    { title: "Problem Statement", description: "Clear definition of the healthcare challenge" },
    { title: "Market Research", description: "Current solutions and gaps" },
    { title: "Target Audience", description: "Who will benefit from your solution" },
    { title: "Proposed Solution", description: "Your innovative approach" },
    { title: "Technology Stack", description: "Tools and technologies used" },
    { title: "Implementation Plan", description: "Step-by-step development approach" },
    { title: "Prototype/Demo", description: "Visual representation or working model" },
    { title: "Business Model", description: "Revenue streams and sustainability" },
    { title: "Impact Assessment", description: "Expected outcomes and benefits" },
    { title: "Challenges & Mitigation", description: "Potential obstacles and solutions" },
    { title: "Future Roadmap", description: "Scaling and enhancement plans" },
    { title: "Thank You", description: "Contact information and acknowledgments" }
  ];
      ...
      <nav className="bg-white border-b border-gray-200 sticky top-20 z-40">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex space-x-8 overflow-x-auto py-4">
            {[
              { id: 'general', label: 'General Instructions', icon: Users },
              { id: 'presentation', label: 'Presentation Guidelines', icon: FileText },
        ...
        <div className="space-y-8">
                ...
                <div className="p-6">
                  ...
                  <div className="mt-8 p-4 bg-green-50 border border-green-200 rounded-lg">
                    <div className="flex items-center">
                      ...
                      <span className="font-semibold text-green-800">Registration Checklist:</span>
                    </div>
                    <ul className="mt-3 space-y-2 text-green-700">
                      <li className="flex items-center space-x-2">
                        <div className="w-2 h-2 bg-green-600 rounded-full"></div>
                        <span>Complete individual registration form</span>
                      </li>
                      <li className="flex items-center space-x-2">
                        <div className="w-2 h-2 bg-green-600 rounded-full"></div>
                        <span>Confirm team name consistency</span>
                      </li>
                      <li className="flex items-center space-x-2">
                        <div className="w-2 h-2 bg-green-600 rounded-full"></div>
                ...
                <div className="p-6">
                  ...
                  <div className="bg-red-50 border border-red-200 rounded-lg p-4 mb-6">
                    ...
                    <p className="text-red-700 mt-2">
                      <strong>Don't use AI for PPT generation.</strong> All presentations must be original work created by team members.
                    </p>
                  </div>
                  ...
                  {/* Slide Outline */}
                  <div className="mb-6">
                    <h3 className="font-semibold text-gray-900 mb-4">Required Slide Outline (13 Slides):</h3>
                  ...
                  <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                    <h3 className="font-semibold text-blue-900 mb-2">Optional Video Submission:</h3>
                    <p className="text-blue-800 text-sm">
                      Teams can optionally submit a 1-4 minute YouTube video explaining their solution. This can enhance your presentation and provide additional context to judges.
                    </p>
                  </div>
                </div>
              </div>
                    ...
                    {timelinePhases.map((phase, index) => (
                      <div key={index} className="relative">
                        <div className="flex items-start space-x-4">
                          <div className={`flex-shrink-0 w-12 h-12 rounded-full border-2 flex items-center justify-center ${getPhaseStyles(phase.color)}`}>
                            <span className="font-bold text-sm">{index + 1}</span>
                          </div>
                          <div className="flex-grow">
                            <div className="flex items-center space-x-2 mb-2">
                              <span className={`px-2 py-1 rounded text-xs font-semibold ${getBadgeStyles(phase.color)}`}>
                                {phase.round}
                              </span>
                ...
                <div className="p-6">
                  ...
                  <div className="mt-6 p-4 bg-gray-50 rounded-lg">
                    ...
                    <ul className="space-y-2 text-sm text-gray-700">
                      <li>• Each criterion will be scored on a scale of 1-10</li>
                      <li>• Multiple judges will evaluate each team independently</li>
                      <li>• Final scores will be averaged across all judges</li>
                      <li>• Top teams from each round advance to the next stage</li>
                    </ul>
                  </div>
                </div>
              </div>
          ...
          <div className="bg-gradient-to-r from-indigo-50 to-blue-50 rounded-xl border border-indigo-200 shadow-lg overflow-hidden">
            <div className="p-8 text-center">
              <h3 className="text-2xl font-bold text-indigo-900 mb-4">Remember</h3>
              <blockquote className="text-lg text-indigo-800 italic leading-relaxed max-w-4xl mx-auto">
                "Whether you win or lose, the most important thing is what you learn from this experience. Every challenge is an opportunity to grow, every setback is a setup for a comeback, and every innovation starts with a single idea. Your journey in this hackathon is not just about the destination, but about the knowledge, skills, and connections you build along the way."
              </blockquote>
          ...
          <div className="text-center">
            ...
            <div className="flex flex-col md:flex-row items-center justify-center space-y-4 md:space-y-0 md:space-x-8">
              ...
              >
                ...
                <span>contact@israeli-indian-hackathon.org</span>
              </a>
              <a
