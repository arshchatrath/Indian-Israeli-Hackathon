...
function Button({
	...
	const baseClasses =
		"inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium transition-all duration-500 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 hover:scale-105 active:scale-95 transform-gpu";
				...
				>
					...
					>
						...
						<div className="text-lg sm:text-xl font-extrabold text-teal-500 mb-2">
							Tel Aviv University, Israel and University of Haifa,
							Israel.
						</div>
					...
					<div className="w-full max-w-7xl mx-auto px-4 flex flex-col xl:flex-row items-start xl:items-center justify-between gap-8 xl:gap-6">
						...
						>
							...
							>
								Unite with visionary innovators from Israel and
								India to revolutionize healthcare technology.
							</motion.p>
							<motion.p
								initial={{ opacity: 0, y: 20 }}
								animate={{ opacity: 1, y: 0 }}
							...
							>
								Build groundbreaking solutions that will
								transform patient care and medical innovation
								across both nations.
							</motion.p>
							...
							>
								...
								>
									<Countdown deadline="2025-08-10T23:59:59" />
								</motion.div>
