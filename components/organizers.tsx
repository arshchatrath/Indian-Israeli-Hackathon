						...
						>
							<div className="rounded-2xl bg-white/90 p-6 sm:p-8">
								...
								<p className="text-base sm:text-lg text-gray-700 leading-relaxed text-justify">
									...
									>
										Centre of Excellence in Data Science & AI
