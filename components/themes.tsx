...
const problemStatements = [
  {
    id: "PS1",
    title: "Enhancing Patient Experience in Restorative Healthcare",
    partner: "REUTH Hospital, Israel",
    description: "Design a solution that ensures transparency, consistency, and clear communication in the restorative healthcare journey - empowering patients with real-time updates, treatment clarity, and improved interaction with healthcare providers.",
    icon: BrainCircuit,
    color: "from-blue-500 to-indigo-600",
    bgColor: "from-blue-50 to-indigo-50",
    tags: ["Patient Experience", "Healthcare Communication", "Treatment Transparency"],
  },
  {
    id: "PS2",
    title: "Enhancing Quality of Life for Ventilated Patients",
    partner: "REUTH Hospital, Israel",
    description: "Design a patient-centric solution that enhances the overall quality of life for ventilated individuals. The solution could focus on improving communication, providing clear and compassionate updates, reducing sensory discomfort, or addressing emotional and psychological well-being.",
    icon: Video,
    color: "from-emerald-500 to-teal-600",
    bgColor: "from-emerald-50 to-teal-50",
    tags: ["Ventilated Patients", "Quality of Life", "Patient Care"],
  },
  {
    id: "PS3",
    title: "Enhancing Caregiver Professionalism and User Experience",
    partner: "Silvergenie",
    description: "Design a solution that elevates the caregiving ecosystem by addressing professionalism, skill development, communication, and continuous learning. Your idea could include digital learning tools, multilingual support systems, caregiver certification pathways, performance tracking, or frameworks for regular upskilling.",
    icon: Activity,
    color: "from-purple-500 to-pink-600",
    bgColor: "from-purple-50 to-pink-50",
    tags: ["Caregiver Training", "Professional Development", "Healthcare Skills"],
  },
  {
    id: "PS4",
    title: "Physiotherapy Companies - Data Intelligence Platform",
    partner: "VRSteps",
    description: "Create a solution that transforms body data collected from VRSteps' acupressure machines into a comprehensive wellness intelligence platform. This could include real-time feedback, progress tracking, AI-powered recommendations, data visualizations, and integration with other health services.",
    icon: Eye,
    color: "from-orange-500 to-red-600",
    bgColor: "from-orange-50 to-red-50",
    tags: ["Physiotherapy", "Data Analytics", "Wellness Intelligence"],
  },
  {
    id: "PS5",
    title: "Gamifying Rehabilitation - Making Recovery Engaging",
    partner: "Tzora Active Systems",
    description: "Design a personalized, game-based rehab experience using data from Tzora's mobility devices. Build interactive challenges that adapt to a patient's condition and progress - with rewards, levels, and real-time feedback — to keep recovery engaging, motivating, and consistent.",
    icon: BarChart3,
    color: "from-cyan-500 to-blue-600",
    bgColor: "from-cyan-50 to-blue-50",
    tags: ["Rehabilitation", "Gamification", "Mobility Devices"],
  },
  {
    id: "PS6",
    title: "AI-driven Physiotherapy for Gait Analysis",
    partner: "ProCare (India)",
    description: "Develop AI-driven physiotherapy solutions for gait analysis and performance optimization in athletes using multimodal sensors. Focus on real-time analysis, biomechanical analysis, and gait scoring for movement optimization.",
    icon: Stethoscope,
    color: "from-indigo-500 to-purple-600",
    bgColor: "from-indigo-50 to-purple-50",
    tags: ["AI/ML", "Gait Analysis", "Athlete Performance"],
  },
  {
    id: "PS7",
    title: "Open Innovation Challenge",
    partner: "Open Category",
    description: "Propose your own innovative healthcare solution addressing unmet medical needs or improving systems. Any other idea related to Restorative Health Case Solution/ Product/ Service.",
    icon: Lightbulb,
