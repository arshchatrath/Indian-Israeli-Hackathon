...
const partnerCategories = [
  {
    ...
    partners: [
      { name: "Tel Aviv University", logo: "/placeholder.svg?height=100&width=200" },
      { name: "IIT Delhi", logo: "/placeholder.svg?height=100&width=200" },
      { name: "Technion", logo: "/placeholder.svg?height=100&width=200" },
      { name: "IISc Bangalore", logo: "/placeholder.svg?height=100&width=200" },
    ],
  },
  {
  ...
  },
  {
    ...
    partners: [
      ...
      { name: "The Times of India", logo: "/placeholder.svg?height=100&width=200" },
  ...
  },
  {
    ...
    partners: [
      { name: "Apollo Hospitals", logo: "/placeholder.svg?height=100&width=200" },
      { name: "Hadassah Medical", logo: "/placeholder.svg?height=100&width=200" },
      { name: "AIIMS", logo: "/placeholder.svg?height=100&width=200" },
      { name: "Sheba Medical", logo: "/placeholder.svg?height=100&width=200" },
    ],
  },
]
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="space-y-16">
          {partnerCategories.map((category, categoryIndex) => (
            ...
            >
              <h3 className="text-2xl font-bold text-gray-900 text-center mb-8">{category.title}</h3>
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
                {category.partners.map((partner, index) => (
                  ...
                  >
                    ...
                    />
                    <p className="text-center text-sm font-medium text-gray-700 mt-3">{partner.name}</p>
                  </motion.div>
                ))}
              </div>
            </motion.div>
