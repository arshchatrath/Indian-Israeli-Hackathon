							...
							<CardContent>
								<div className="mb-4">
									...
									<ul className="list-disc list-inside space-y-2 text-gray-700 text-base pl-2">
										<li>
											Open to undergraduate/graduate
											students (any discipline) and
											working professionals currently
											residing in <b>India</b> or{" "}
											<b>Israel</b>.
										</li>
										<li>
											<b>Thapar students</b> must
											participate offline; others will
											join online.
										</li>
										<li>
								...
								<div>
									...
									<ul className="list-disc list-inside space-y-2 text-gray-700 text-base pl-2">
										<li>
											All ideas must be original and built
											during the hackathon.
										</li>
										<li>
											Teams must take part in all 3 rounds
											to stay eligible.
										</li>
										<li>
											Offline teams present at the venue;
											online teams submit projects
											digitally.
										</li>
										<li>
											Each participant can join only one
											team.
										</li>
										<li>
											Maintain a respectful and ethical
											code of conduct.
										</li>
									</ul>
								</div>
								...
								<CardContent className="space-y-4">
									...
									<div>
										...
										<p className="text-gray-600">
											...
											participation certificates. Winners
									...
									<div>
										...
										<p className="text-gray-600">
											...
											mentorship, and potential internship
											offers for outstanding participants.
										</p>
									</div>
								</CardContent>
							</Card>
