              ...
              <CardContent>
                <div className="mb-4">
                  ...
                  <ul className="list-disc list-inside space-y-2 text-gray-700 text-base pl-2">
                    <li>
                      Open to undergraduate/graduate students (any discipline)
                      and working professionals currently residing in{" "}
                      <b>India</b> or <b>Israel</b>.
                    </li>
                    <li>
                      <b>Thapar students</b> must participate offline; others
                      will join online.
                    </li>
                    <li>
                      Teams of <b>1-6 members</b>.
                    </li>
                    <li>
                      Must have basic technical knowledge in chosen domain.
                    </li>
                ...
                <div>
                  ...
                  <ul className="list-disc list-inside space-y-2 text-gray-700 text-base pl-2">
                    <li>
                      All ideas must be original and built during the hackathon.
                    </li>
                    <li>
                      Teams must take part in all 3 rounds to stay eligible.
                    </li>
                    <li>
                      Offline teams present at the venue; online teams submit
                      projects digitally.
                    </li>
                ...
                <CardContent className="space-y-4">
                  <div>
                    ...
                    <p className="text-gray-600">
                      Final results will be announced within 48 hours of
                      Round-III completion
                    </p>
                  </div>
                  <div>
                    <h4 className="font-semibold text-gray-900 mb-2">
                    ...
                    <p className="text-gray-600">
                      ...
                      Winners get special recognition certificates.
                    </p>
                  </div>
                  <div>
                    <h4 className="font-semibold text-gray-900 mb-2">
                    ...
                    <p className="text-gray-600">
                      Networking opportunities, mentorship, and potential
                      internship offers for outstanding participants.
                    </p>
                  </div>
                </CardContent>
              </Card>
