...
import { ChevronDown, Award, Target, Users, Lightbulb, ShieldCheck, Globe2, UserCheck, BookOpen, Star, Scale } from "lucide-react"
...
const selectionCriteria = [
  ...
  },
  {
    ...
    description: "A mix of professionals from startups, tech companies, academia, and government bodies for balanced perspectives.",
  },
  {
    icon: BookOpen,
  ...
  },
  {
    ...
    description: "Judges from diverse sectors like academia, startups, corporate R&D, and venture capital for well-rounded feedback.",
  },
  {
    icon: Star,
    title: "Reputation & Credibility",
    description: "Well-respected in their domain, recognized by peers, or have significant contributions in their field.",
  },
  {
    icon: Scale,
    title: "Neutrality",
...
const selectionProcess = [
  {
    ...
    detail: "Reach out to industry leaders, professors, startup founders, and past hackathon winners. Seek recommendations from sponsors, organizing committees, and past judges. Utilize LinkedIn, professional networks, and academic conferences to find qualified individuals.",
  },
  {
    step: "Screening & Shortlisting",
    detail: "Verify credentials, technical expertise, and past judging experience. Ensure a balance between industry professionals and academicians. Confirm willingness and availability to judge fairly and effectively.",
  },
  {
    step: "Invitation & Confirmation",
    detail: "Send formal invitations outlining responsibilities, judging criteria, and the event schedule. Obtain a commitment and ensure they agree to ethical guidelines.",
  },
  {
    step: "Briefing & Orientation",
    detail: "Conduct a pre-hackathon session to explain scoring criteria, expected evaluation depth, and guidelines. Provide judges with hackathon themes, submission guidelines, and scoring rubrics in advance.",
  },
]
    ...
    <div className="py-20 bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-xl text-gray-600 mb-6">Industry leaders who will evaluate your innovations</p>
          <div className="flex flex-wrap justify-center gap-4">
            ...
            >
              ...
              <ChevronDown className={`ml-2 h-4 w-4 transition-transform ${showEligibility ? "rotate-180" : ""}`} />
            </Button>
            <Button
            ...
            >
              Selection Process
              <ChevronDown className={`ml-2 h-4 w-4 transition-transform ${showProcess ? "rotate-180" : ""}`} />
            </Button>
          </div>
        </motion.div>
        ...
        >
          <div className="bg-white rounded-lg p-6 shadow-lg max-w-3xl mx-auto"> {/* p-8 -> p-6 */}
            <h3 className="text-2xl font-bold text-blue-700 mb-4 text-center">Eligibility Criteria for Judges</h3>
        ...
        >
          <div className="bg-white rounded-lg p-6 shadow-lg">
            <h3 className="text-2xl font-bold text-blue-700 mb-6 text-center">Selection Criteria</h3>
        ...
        >
          <div className="bg-white rounded-lg p-6 shadow-lg max-w-3xl mx-auto">
            <h3 className="text-2xl font-bold text-blue-700 mb-4 text-center">Selection Process</h3>
            <ol className="list-decimal list-inside text-gray-700 space-y-4 text-left">
              {selectionProcess.map((step, idx) => (
                <li key={idx}>
                  <span className="font-semibold">{step.step}:</span> {step.detail}
                </li>
              ))}
            </ol>
          </div>
