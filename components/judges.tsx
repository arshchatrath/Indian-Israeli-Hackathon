...
export default function Judges() {
	...
	return (
		<div className="py-20 bg-gradient-to-br from-gray-50 via-blue-50/30 to-indigo-50/30 min-h-screen">
			<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
				...
				>
					...
					<p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto leading-relaxed">
						Meet our distinguished panel of industry leaders and technical experts who will evaluate your innovations with their wealth of experience
					</p>
				...
				{/* Judges Grid - Updated for better mobile responsiveness */}
